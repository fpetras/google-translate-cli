...
def languages(lang):
	if (sys.version_info >= (3, 0)): # if python version > 3
		if (lang.lower() == 'afrikaans' or lang.lower() == 'af' or lang.lower() == 'afr'):
			...
			return 'sq'
		elif (lang.lower() == 'amharic' or lang == u'አማርኛ' or lang.lower() == 'am' or lang.lower() == 'amh'):
			return 'am'
		elif (lang.lower() == 'arabic' or lang == u'العربية' or lang.lower() == 'ar' or lang.lower() == 'ara'):
			return 'ar'
		elif (lang.lower() == 'armenian' or lang == u'Հայերեն' or lang.lower() == 'hy' or lang.lower() == 'arm' or lang.lower() == 'hye'):
			return 'hy'
		elif (lang.lower() == 'azerbaijani' or lang.lower() == u'azərbaycanca' or lang.lower() == 'az' or lang.lower() == 'aze'):
			return 'az'
		elif (lang.lower() == 'basque' or lang.lower() == 'euskara' or lang.lower() == 'eu' or lang.lower() == 'eur' or lang.lower() == 'baq'):
			return 'eu'
		elif (lang.lower() == 'belarusian' or lang == u'беларуская' or lang.lower() == 'be' or lang.lower() == 'bel'):
			return 'be'
		elif (lang.lower() == 'bengali' or lang == u'বাংলা' or lang.lower() == 'bn' or lang.lower() == 'ben'):
			return 'bn'
		elif (lang.lower() == 'bosnian' or lang.lower() == 'bosanski' or lang.lower() == 'bs' or lang.lower() == 'bos'):
			return 'bs'
		elif (lang.lower() == 'bulgarian' or lang == u'български' or lang.lower() == 'bg' or lang.lower() == 'bul'):
			return 'bg'
		elif (lang.lower() == 'catalan' or lang.lower() == u'català' or lang.lower() == 'catala' or lang.lower() == 'cat'):
			return 'ca'
			...
			return 'hr'
		elif (lang.lower() == 'czech' or lang.lower() == u'čeština' or lang.lower() == 'cestina' or lang.lower() == 'cs' or lang.lower() == 'ces' or lang.lower() == 'cze'):
			return 'cs'
			...
			return 'fi'
		elif (lang.lower() == 'french' or lang.lower() == u'français' or lang.lower() == 'francais' or lang.lower() == 'fr' or lang.lower() == 'fre' or lang.lower() == 'fra'):
			return 'fr'
			...
			return 'gl'
		elif (lang.lower() == 'georgian' or lang == u'ქართული' or lang.lower() == 'ka' or lang.lower() == 'kat' or lang.lower() == 'geo'):
			return 'ka'
		elif (lang.lower() == 'german' or lang.lower() == 'deutsch' or lang.lower() == 'de' or lang.lower() == 'deu' or lang.lower() == 'ger'):
			return 'de'
		elif (lang.lower() == 'greek' or lang == u'Ελληνικά' or lang.lower() == 'el' or lang.lower() == 'ell' or lang.lower() == 'gre'):
			return 'el'
		elif (lang.lower() == 'gujarati' or lang == u'ગુજરાતી' or lang.lower() == 'gu' or lang.lower() == 'guj'):
			return 'gu'
		elif (lang.lower() == 'haitian creole' or lang.lower() == u'kreyòl ayisyen' or lang.lower() == 'kreyol ayisyen' or lang.lower() == 'haitian' or lang.lower() == 'ht' or lang.lower() == 'hat'):
			return 'ht'
		elif (lang.lower() == 'hausa' or lang.lower() == 'ha' or lang.lower() == 'hau'):
			return 'ha'
		elif (lang.lower() == 'hawaiian' or lang.lower() == u'ʻōlelo hawaiʻi' or lang.lower() == 'haw'):
			return 'haw'
		elif (lang.lower() == 'hebrew' or lang == u'עִבְרִית' or lang.lower() == 'he' or lang.lower() == 'heb'):
			return 'he'
		elif (lang.lower() == 'hindi' or lang == u'हिन्दी' or lang.lower() == 'hi' or lang.lower() == 'hin'):
			return 'hi'
			...
			return 'hu'
		elif (lang.lower() == 'icelandic' or lang.lower() == u'íslenska' or lang.lower() == 'islenska' or lang.lower() == 'is' or lang.lower() == 'isl' or lang.lower() == 'ice'):
			return 'is'
			...
			return 'it'
		elif (lang.lower() == 'japanese' or lang == u'日本語' or lang.lower() == 'ja' or lang.lower() == 'jpn'):
			return 'ja'
		elif (lang.lower() == 'javanese' or lang.lower() == 'basa jawa' or lang.lower() == 'jv' or lang.lower() == 'jav'):
			return 'jv'
		elif (lang.lower() == 'kannada' or lang == u'ಕನ್ನಡ' or lang.lower() == 'kn' or lang.lower() == 'kan'):
			return 'kn'
		elif (lang.lower() == 'kazakh' or lang == u'Қазақ тілі' or lang.lower() == 'kk' or lang.lower() == 'kaz'):
			return 'kk'
		elif (lang.lower() == 'khmer' or lang == u'ភាសាខ្មែរ' or lang.lower() == 'km' or lang.lower() == 'khm'):
			return 'km'
		elif (lang.lower() == 'korean' or lang == u'한국어' or lang.lower() == 'ko' or lang.lower() == 'kor'):
			return 'ko'
		elif (lang.lower() == 'kurdish' or lang.lower() == u'kurdî' or lang.lower() == 'kurdi' or lang.lower() == 'kurmanji' or lang.lower() == 'ku' or lang.lower() == 'kur'):
			return 'ku'
		elif (lang.lower() == 'kyrgyz' or lang == u'Кыргызча' or lang.lower() == 'ky' or lang.lower() == 'kir'):
			return 'ky'
		elif (lang.lower() == 'lao' or lang == u'ລາວ' or lang.lower() == 'lo'):
			return 'lo'
		elif (lang.lower() == 'latin' or lang.lower() == 'latina' or lang.lower() == 'la' or lang.lower() == 'lat'):
			return 'la'
		elif (lang.lower() == 'latvian' or lang.lower() == u'latviešu' or lang.lower() == 'latviesu' or lang.lower() == 'lv' or lang.lower() == 'lav'):
			return 'lv'
		elif (lang.lower() == 'lithuanian' or lang.lower() == u'lietuvių' or lang.lower() == 'lietuviu' or lang.lower() == 'lt' or lang.lower() == 'lit'):
			return 'lt'
		elif (lang.lower() == 'luxembourgish' or lang.lower() == u'lëtzebuergesch' or lang.lower() == 'letzebuergesch' or lang.lower() == 'lb' or lang.lower() == 'ltz'):
			return 'lb'
		elif (lang.lower() == 'macedonian' or lang == u'Македонски' or lang.lower() == 'mk' or lang.lower() == 'mkd' or lang.lower() == 'mac'):
			return 'mk'
			...
			return 'ms'
		elif (lang.lower() == 'malayalam' or lang == u'മലയാളം' or lang.lower() == 'ml' or lang.lower() == 'mal'):
			return 'ml'
		elif (lang.lower() == 'maltese' or lang.lower() == 'malti' or lang.lower() == 'mt' or lang.lower() == 'mlt'):
			return 'mt'
		elif (lang.lower() == 'maori' or lang.lower() == u'māori' or lang.lower() == 'mi' or lang.lower() == 'mao' or lang.lower() == 'mri'):
			return 'mi'
		elif (lang.lower() == 'marathi' or lang == u'मराठी' or lang.lower() == 'mr' or lang.lower() == 'mar'):
			return 'mr'
		elif (lang.lower() == 'mongolian' or lang == u'Монгол' or lang.lower() == 'mn' or lang.lower() == 'mon'):
			return 'mn'
		elif (lang.lower() == 'myanmar' or lang == u'မြန်မာစာ' or lang.lower() == 'burmese' or lang.lower() == 'my' or lang.lower() == 'mya' or lang.lower() == 'bur'):
			return 'my'
		elif (lang.lower() == 'nepali' or lang == u'नेपाली'or lang.lower() == 'ne' or lang.lower() == 'nep'):
			return 'ne'
		elif (lang.lower() == 'norwegian' or lang.lower() == 'norsk' or lang.lower() == 'no' or lang.lower() == 'nor'):
			return 'no'
		elif (lang.lower() == 'pashto' or lang == u'پښتو' or lang.lower() == 'ps' or lang.lower() == 'pus'):
			return 'ps'
		elif (lang.lower() == 'persian' or lang.lower() == 'farsi' or lang == u'فارسی' or lang.lower() == 'fa' or lang.lower() == 'fas' or lang.lower() == 'per'):
			return 'fa'
		elif (lang.lower() == 'polish' or lang.lower() == 'polski' or lang.lower() == 'pl' or lang.lower() == 'pol'):
			return 'pl'
		elif (lang.lower() == 'portuguese' or lang.lower() == u'português' or lang.lower() == 'portugues' or lang.lower() == 'pt' or lang.lower() == 'por'):
			return 'pt'
		elif (lang.lower() == 'punjabi' or lang == u'ਪੰਜਾਬੀ' or lang.lower() == 'pa' or lang.lower() == 'pan'):
			return 'pa'
		elif (lang.lower() == 'romanian' or lang.lower() == u'română' or lang.lower() == 'romana' or lang.lower() == 'ro' or lang.lower() == 'ron' or lang.lower() == 'rum'):
			return 'ro'
		elif (lang.lower() == 'russian' or lang == u'Русский' or lang.lower() == 'ru' or lang.lower() == 'rus'):
			return 'ru'
		elif (lang.lower() == 'samoan' or lang.lower() == u'gagana sāmoa' or lang.lower() == 'gagana samoa' or lang.lower() == 'sm' or lang.lower() == 'smo'):
			return 'sm'
		elif (lang.lower() == 'scots gaelic' or lang.lower() == 'scottish gaelic' or lang.lower() == 'gaelic' or lang.lower() == u'gàidhlig' or lang.lower() == 'gaidhlig' or lang.lower() == 'gd' or lang.lower() == 'gla'):
			return 'gd'
		elif (lang.lower() == 'serbian' or lang == u'српски' or lang.lower() == 'sr' or lang.lower() == 'srp' or lang.lower() == 'sr-cy' or lang.lower() == 'sr-cyrl'):
			return 'sr'
			...
			return 'sn'
		elif (lang.lower() == 'sindhi' or lang == u'سنڌي' or lang.lower() == 'sd' or lang.lower() == 'snd'):
			return 'sd'
		elif (lang.lower() == 'sinhala' or lang == u'සිංහල' or lang.lower() == 'si' or lang.lower() == 'sin'):
			return 'si'
		elif (lang.lower() == 'slovak' or lang.lower() == u'slovenčina' or lang.lower() == 'slovencina' or lang.lower() == 'sk' or lang.lower() == 'slk' or lang.lower() == 'slo'):
			return 'sk'
		elif (lang.lower() == 'slovenian' or lang.lower() == u'slovenščina' or lang.lower() == 'slovenscina' or lang.lower() == 'sl' or lang.lower() == 'slv'):
			return 'sl'
		elif (lang.lower() == 'somali' or lang.lower() == 'soomaali' or lang.lower() == 'so' or lang.lower() == 'som'):
			return 'so'
		elif (lang.lower() == 'spanish' or lang.lower() == u'español' or lang.lower() == 'espanol' or lang.lower() == 'es' or lang.lower() == 'spa'):
			return 'es'
			...
			return 'sv'
		elif (lang.lower() == 'tajik' or lang == u'Тоҷикӣ' or lang.lower() == 'tg' or lang.lower() == 'tgk'):
			return 'tg'
		elif (lang.lower() == 'tamil' or lang == u'தமிழ்' or lang.lower() == 'ta' or lang.lower() == 'tam'):
			return 'ta'
		elif (lang.lower() == 'telugu' or lang == u'తెలుగు' or lang.lower() == 'te' or lang.lower() == 'tel'):
			return 'te'
		elif (lang.lower() == 'thai' or lang == u'ไทย' or lang.lower() == 'th' or lang.lower() == 'tha'):
			return 'th'
		elif (lang.lower() == 'turkish' or lang.lower() == u'türkçe' or lang.lower() == 'turkce' or lang.lower() == 'tr' or lang.lower() == 'tur'):
			return 'tr'
		elif (lang.lower() == 'ukrainian' or lang == u'Українська' or lang.lower() == 'uk' or lang.lower() == 'ukr'):
			return 'uk'
		elif (lang.lower() == 'urdu' or lang == u'اُردُو' or lang.lower() == 'ur' or lang.lower() == 'urd'):
			return 'ur'
		elif (lang.lower() == 'uzbek' or lang.lower() == u'oʻzbek tili' or lang.lower() == 'uz' or lang.lower() == 'uzb'):
			return 'uz'
		elif (lang.lower() == 'vietnamese' or lang.lower() == u'tiếng việt' or lang.lower() == 'tieng viet' or lang.lower() == 'vi' or lang.lower() == 'vie'):
			return 'vi'
			...
			return 'xh'
		elif (lang.lower() == 'yiddish' or lang == u'ייִדיש' or lang.lower() == 'yi' or lang.lower() == 'yid'):
			return 'yi'
		elif (lang.lower() == 'yoruba' or lang.lower() == u'yorùbá' or lang.lower() == 'yo' or lang.lower() == 'yor'):
			return 'yo'
